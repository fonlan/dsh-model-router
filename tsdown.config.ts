/**
 * tsdown build for @fonlan/dsh-model-router: the host-half lib (lib/index.js, ESM
 ...
 * with the package-name id `@fonlan/dsh-model-router` (the client-modules compose
 * keys on the package name; keep it in sync with package.json `name`).
 * Externals resolve through the loader module table at runtime; everything
...
export default [
  ...
  clientBundle('@fonlan/dsh-model-router', 'client.js'),
